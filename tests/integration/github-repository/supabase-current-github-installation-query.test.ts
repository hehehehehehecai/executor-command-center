...
import { SupabaseCurrentGitHubInstallationQuery } from "../../../src/infrastructure/github/supabase-current-github-installation-query";
...
describe("github repository installation query with Local Supabase", () => {
  ...
  it("reads only the current user's installation through the callback service role", async () => {
    const userId = randomUUID();
    const githubUserId = 7_500_001;
