...
export function parseServerEnvironment(
  ...
  return parseEnvironment({
    ...
    STAGING_VERIFICATION_ENABLED: source.STAGING_VERIFICATION_ENABLED,
    STAGING_VERIFICATION_PROJECT_ID: source.STAGING_VERIFICATION_PROJECT_ID,
    STAGING_VERIFICATION_INSTALLATION_ID: source.STAGING_VERIFICATION_INSTALLATION_ID,
    STAGING_VERIFICATION_REPOSITORY: source.STAGING_VERIFICATION_REPOSITORY,
  });
}
