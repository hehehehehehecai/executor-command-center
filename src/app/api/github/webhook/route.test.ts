...
describe("POST /api/github/webhook", () => {
  ...
  it("is dynamic and returns only stable result fields", async () => {
    const response = await POST(new Request("https://example.test/api/github/webhook", { method: "POST", body: '{"x":1}', headers: { "x-github-delivery": "11111111-1111-4111-8111-111111111111", "x-github-event": "push", "x-hub-signature-256": `sha256=${"a".repeat(64)}` } }));
